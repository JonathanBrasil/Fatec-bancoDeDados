...
insert into Categorias (Categoria,Descricao,valor)
 ...
 select * from categorias       
   ...
   CREATE TABLE Funcionarios (
        ...
        insert into Funcionarios (NomeFunc, Endereco,Bairro,Cidade,Estado,Pais,cep,Cargo,Usuario,senha,Nivel)
         values ('Ana Maria','R. das Flores','Orquideas','Santo André','São Paulo','Brasil','09856210','Auxiliar','ana','123',1)
        
        insert into Funcionarios (NomeFunc, Endereco,Bairro,Cidade,Estado,Pais,cep,Cargo,usuario,senha,Nivel)
         values ('Eva Silva', 'R. das Uvas','Frutas','Mauá','São Paulo','Brasil','03021580','Ass.Adm.','eva','456',2)
         
         insert into Funcionarios (NomeFunc, Endereco,Bairro,Cidade,Estado,Pais,cep,Cargo,usuario,senha,Nivel)
         values ('Rui','R. das Amoras','Frutas','Mauá','São Paulo','Brasil','09715000','Gerente','rui','789',3)
...
insert into clientes (Cliente,endereco,bairro,cidade,pais,Estado,cep,dataNasc ,cnh)
         values ('Ana Maria','R. Pera','Frutas',
                   'São Bernardo do Campo','Brasil','SP','01954600','01/01/1976','12345678912')


insert into clientes (Cliente,endereco,bairro,cidade,pais,Estado,cep,dataNasc ,cnh)
         values ('Eva Silva','R. Maçã','Frutas',
                   'São Bernardo do Campo','Brasil','SP','01654700','15/10/1986','19541268912')


insert into clientes (Cliente,endereco,bairro,cidade,pais,Estado,cep,dataNasc ,cnh)
         values ('Maria Madalena','R. Amoras','Frutas',
                   'Buenos Aires','Argentina','SP','08520100','07/02/1987','12345632156')


insert into clientes (Cliente,endereco,bairro,cidade,pais,Estado,cep,dataNasc ,cnh)
         values ('Mario Augusto Lopez','R. Orquidesas','Flores',
                   'Santa Rosa','Argentina','SP','06240100','09/02/1995','12348521479')

insert into clientes (Cliente,endereco,bairro,cidade,pais,Estado,cep,dataNasc ,cnh)
         values ('Adriano Ricco','R. Bromélias','Flores',
                   'São Bernardo do Campo','Brasil','SP','07890100','21/08/1965','18448523698')


insert into clientes (Cliente,endereco,bairro,cidade,pais,Estado,cep,dataNasc ,cnh)
         values ('Rafael Bastos','R. Estonia','Parque das Nações',
                   'Santo andré','Brasil','SP','09870100','12/08/1982','129712348813')



insert into clientes (Cliente,endereco,bairro,cidade,pais,Estado,cep,dataNasc ,cnh)
         values ('Rodrigo Dantas','R. Polonia','Parque das Nações',
                   'Aguas Calientes','Peru','SP','06540100','04/04/1953','1298745893')



insert into clientes (Cliente,endereco,bairro,cidade,pais,Estado,cep,dataNasc ,cnh)
         values ('Danilo Alves','R. Estonia','Parque das Nações',
                   'Santo andré','Brasil','SP','02456700','01/01/1982','129787458913')


insert into clientes (Cliente,endereco,bairro,cidade,pais,Estado,cep,dataNasc ,cnh)
         values ('Rafael Bastos','R. Dom Pedro II','Jardins',
                   'Santo andré','Brasil','SP','02456700','01/09/1982','12987123913')


insert into clientes (Cliente,endereco,bairro,cidade,pais,Estado,cep,dataNasc ,cnh)
         values ('Amanda Bastos','R. Protogenes','Jardins',
                   'Santo andré','Brasil','SP','01987400','01/09/1982','12787123976')


insert into clientes (Cliente,endereco,bairro,cidade,pais,Estado,cep,dataNasc ,cnh)
         values ('Rosana Braga','R. da garça','Assunção',
                   'Santo andré','Brasil','SP','01871100','01/09/1992','12787185697')

insert into clientes (Cliente,endereco,bairro,cidade,pais,Estado,cep,dataNasc ,cnh)
         values ('Rita Moreira','R. das Laranjeiras','Assunção',
                   'Santo andré','Brasil','SP','01450100','15/07/1981','12321456852')
...
update locacoes set dataLocacao= dateadd (mm,90,datalocacao),
						dataretirada= dateadd (mm,90,dataretirada),
						dataentrega= dateadd (mm,90,dataentrega) ,
					datadevolucao= dateadd (mm,90,datadevolucao)
